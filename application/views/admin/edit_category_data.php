 ...
 <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form action="<?= base_url() ?>admincontroller/update_category" method="post">
                    <input type="hidden" name="cat_id" value="<?= $cat_info[0]['cat_id'] ?>" id="">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control text-white" placeholder="Enter Category Name" aria-label="Username" name="category_name" aria-describedby="basic-addon1" required value="<?= $cat_info[0]['category_name'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="cat_status" aria-label="Default select example">
                                            <option class="text-white" value="<?= $cat_info[0]['cat_status'] ?>"><?= $cat_info[0]['cat_status'] ?></option>
