 ...
 <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form action="<?= base_url() ?>admincontroller/save_facility_info" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control text-white" placeholder="Enter Facility Title" aria-label="Username" name="fac_title" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control text-white" placeholder="Enter Facility Description" aria-label="Username" name="fac_desc" aria-describedby="basic-addon1" required></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
